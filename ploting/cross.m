% plot cross-correlation of Zadoff-Chu sequence
...
dt_u1_2 = datatip(p1,'DataIndex',101,'FontSize',12);
dt_u2_1 = datatip(p2,'DataIndex',301,'FontSize',12);
...
'Correlation between $\mathbf{X_{u1,0}}$ and $\mathbf{X_{u2,0}}$', ...
